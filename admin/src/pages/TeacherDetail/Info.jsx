...
export default function 선생님정보박스 ({ data, setData }) {
  ...
  const save = () => {
    ...
    useAxios.put('/teacherModify', send).then(({ data }) => {
      if (!data?.result) {
  ...
  return (
    ...
    <Wrap>
      ...
      {/* <FileInput type='file' id='teacherProfileImage' /> */}
      <ProfileImage img={data?.IMG} htmlFor='teacherProfileImage' />
      <RowWrap>
        <Row>
